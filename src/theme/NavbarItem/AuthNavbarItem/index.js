...
const Modal = ({ show, onClose, children }) => {
  ...
  return (
    <div style={{
      ...
      <div style={{
        backgroundColor: 'var(--docusaurus-sidebar-background-color)', // Use Docusaurus theme color
        padding: '20px',
        borderRadius: '8px',
        minWidth: '300px',
...
const AuthNavbarItem = ({ className }) => {
      ...
      {isAuthenticated ? (
        ...
        <div className="dropdown dropdown--hoverable">
          ...
          <ul className="dropdown__menu">
            ...
            <li>
              <Link to="#" className="dropdown__link" onClick={handleLogout}>
                Log Out
              </Link>
            </li>
          </ul>
